...
forecast_list = ['01+11','02+10','03+09','04+08','05+07','06+06','07+05','08+04','09+03','10+02','11+01','Strat Plan']
...
comp_output = h.generate_df_changes(curr_df, prev_df, 'Vein', forecast_select)
st.code(comp_output)
